...
import { registerUserValidation, setPinValidation, updateUserValidation } from "../validations/user.validation";
...
export namespace UserTypes {
  ...
  export type GetByIdParams = z.infer<typeof idValidation>;
	...
	export type SetPinParams = z.infer<typeof setPinValidation>;
}
