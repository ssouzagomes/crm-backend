...
export const updateUserPermissions = z.object({
	user_id: z.number(),
	flags: z.string().array(),
	permissionAKA: z.string().array(),
...
export const setPinValidation = z.object({
	id: z.number().nonnegative(),
	pin: z.string().max(4, 'REQUIRED 4').min(4, 'REQUIRED 4'),
	type: z.enum(['set', 'update']),
	newPin: z.string().max(4, 'REQUIRED 4').min(4, 'REQUIRED 4').optional(),
});
